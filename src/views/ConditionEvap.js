...
const ConditionEvap = ({ onSave, onInitData }) => {
  const defaultData = [
    {
      device: "Pump",
      minTemp: 0,
  ...
  useEffect(() => {
    const initData = () => {
      const storageData = localStorage.getItem(conditionOptions[0].value)
